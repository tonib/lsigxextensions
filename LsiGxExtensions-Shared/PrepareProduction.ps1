...
# Extensions version:
$ExtensionsVersion = "2.11.0"

# Extensions project path
$PublicExtensionsPath = "D:\kbases\subversion\lsigxextensions\trunk\LsiGxExtensions"

# Private extensions path
$PrivateExtensionsPath = "D:\kbases\subversion\ExtensionesGXPrivadas\trunk\LsiGxPrivateExtensions"
...
# Public extensions
$PathZipBin = $PublicExtensionsPath + "\LsiExtensions-" + $ExtensionsVersion + "_Ev3_U3.zip"
...
# Private extensions
$PathZipBin = $PublicExtensionsPath + "\LsiExtensionesPrivadas-" + $ExtensionsVersion + "_Ev3_U3.zip"
